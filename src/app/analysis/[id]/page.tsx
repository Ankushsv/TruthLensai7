...
import { AlertCircle, ArrowLeft, CheckCircle, ExternalLink, HelpCircle, Link as LinkIcon, ListTree, Newspaper } from 'lucide-react';
                ...
                <CardContent className="space-y-6">
                    ...
                    {record.flags && record.flags.length > 0 && (
                        <div className="space-y-3">
                            <h3 className="text-lg font-semibold flex items-center gap-2"><ListTree className="size-5 text-primary" /> Potential Issues</h3>
                    ...
                    {record.sourcesChecked && record.sourcesChecked.length > 0 && (
                        <div className="space-y-3">
                            <h3 className="text-lg font-semibold flex items-center gap-2"><Newspaper className="size-5 text-primary" /> Sources Checked</h3>
                            <div className="flex flex-wrap gap-2">
                    ...
                    {record.factCheckReferences && record.factCheckReferences.length > 0 && (
                        <div className="space-y-3">
                             <h3 className="text-lg font-semibold flex items-center gap-2"><LinkIcon className="size-5 text-primary" /> Fact-Check References</h3>
                            <ul className="list-disc pl-5 space-y-2 text-sm">
                                {record.factCheckReferences.map((ref, index) => (
                                   <li key={index}>
                                        <a href={ref} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center gap-1.5">
                                           {ref} <ExternalLink className="size-3.5" />
                                        </a>
                                   </li>
                                ))}
                            </ul>
